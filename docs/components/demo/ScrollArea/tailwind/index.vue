...
<template>
  <ScrollAreaRoot class="h-34 w-96 max-w-[calc(100vw-8rem)]">
    <ScrollAreaViewport class="h-full rounded-md outline-1 -outline-offset-1 outline-gray-200 focus-visible:outline-2 focus-visible:outline-blue-800">
    ...
    <ScrollAreaScrollbar class="m-2 flex w-1 justify-center rounded-sm bg-gray-200 opacity-0 transition-opacity pointer-events-none data-hovering:opacity-100 data-hovering:delay-0 data-hovering:pointer-events-auto data-scrolling:opacity-100 data-scrolling:duration-0 data-scrolling:pointer-events-auto">
      <ScrollAreaThumb class="w-full rounded-sm bg-gray-500" />
    </ScrollAreaScrollbar>
  </ScrollAreaRoot>
</template>
