...
<template>
  <TooltipProvider>
    <div class="ButtonGroup">
      <TooltipTrigger
        :handle="tooltip"
        :payload="{ label: 'Listen to audio preview' }"
        class="IconButton"
      ...
      <TooltipTrigger
        :handle="tooltip"
        :payload="{ label: 'Delete: This action cannot be undone' }"
        class="IconButton"
    ...
    <TooltipRoot v-slot="{ payload }" :handle="tooltip">
      <TooltipPortal>
        <TooltipPositioner class="Positioner" :side-offset="11">
          <TooltipPopup class="Popup">
            <TooltipArrow class="Arrow" />
            <TooltipViewport class="Viewport">
