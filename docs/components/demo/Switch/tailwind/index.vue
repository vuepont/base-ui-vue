...
<template>
  <label class="flex items-center gap-2 text-base font-normal text-gray-900">
    <SwitchRoot
    ...
    >
      <SwitchThumb class="aspect-square h-full rounded-full bg-white shadow-[0_0_1px_1px,0_1px_1px,1px_2px_4px_-1px] shadow-gray-100 transition-transform duration-150 data-[checked]:translate-x-4 dark:shadow-black/25" />
    </SwitchRoot>
    Notifications
  </label>
</template>
